...
const SERIF_ROW = 'flex min-w-0 flex-1 items-center gap-1.5 px-2 py-[2px] font-serif text-[12px] leading-[1.15]';
...
export function NavListRow({
  ...
  return (
    <div
      ...
      className={`group flex ${serif ? 'items-center' : 'items-baseline'} ${rowStateClass(row.state)} ${dimmed ? 'opacity-50' : ''}`}
    >
