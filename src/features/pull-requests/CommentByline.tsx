...
export const COMMENT_ACTION =
  'rounded px-1 leading-4 text-ink-dim hover:bg-btn-hover hover:text-ink disabled:opacity-40 disabled:hover:bg-btn disabled:hover:text-ink-dim';
  ...
  return (
    <HoverCardTrigger label="Open on GitHub" focusable={false} tooltipStyle>
      <a
        ...
        className={`${COMMENT_ACTION} ${className}`}
      >
        ↗
      </a>
    </HoverCardTrigger>
